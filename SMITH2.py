...
def wishme():
    ...
    print("SMITH at your service sir, please tell me how may I help you.")
...
def screenshot():
    ...
    print("Screenshot taken, please check your Pictures folder.")
...
def set_alarm(time):
    ...
    print(f"Setting an alarm for {time}")
    tm.sleep(time_diff)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "time" in query:
            ...
            print("I'm SMITH created by Mr. Sai Ganesh and I'm a desktop voice assistant.")
            ...
            try:
                ...
                print("You haven't told me to remember anything.")
